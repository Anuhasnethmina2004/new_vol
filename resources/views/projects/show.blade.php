            ...
            <div>
               ...
               <div class="grid grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <label for="">{{$project->starting_date}}</label>
            
                    <h3 class="font-semibold text-xl text-gray-800 leading-tight">
                        Location
                    </h3>
                    <label for="">{{$project->end_date}}</label>
            
                    <h3 class="font-semibold text-xl text-gray-800 leading-tight">
                        Number Of Hours
                    </h3>
                    <label for="">{{$project->number_of_hours}}</label>
                </div>
            </div>
            <a class="font-semibold text-xl text-gray-800 leading-tight linka" href="{{$project->link}}">Click here for join Group And more Details</a>
