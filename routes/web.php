...
Route::put('/profile/{id}', [ProjectController::class, 'update'])->name('profile.update');
Route::get('/projects/{project}', [ProjectController::class, 'show'])->name('projects.show');

// Route::put('/profile/{id}', 'ProfileController@update')->name('profile.update');
//     Route::get('/projects/{project}', 'ProjectController@show')->name('projects.show');
// Route::get('/report/organization', 'App\Http\ControllersReportController@organization')->name('report.organization');
...
Route::group(['middleware' => 'auth'], function(){
    ...
    // Route::put('/profile/{id}', 'ProfileController@update')->name('profile.update');
    // Route::get('/projects/{project}', 'ProjectController@show')->name('projects.show');
    // Route::get('/report/organization', 'ReportController@organization')->name('report.organization');
